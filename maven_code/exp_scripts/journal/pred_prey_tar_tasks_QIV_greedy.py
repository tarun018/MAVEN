...
server_list = [
    ("draco", [0, 1, 2, 3, 4, 5, 6, 7], 2)
]

label = "QIV_greedy_qmix_v1"
config = "vdn_journal_greedy_exploration"
...
shared_params = {
    "local_results_path": "/data/draco/tarpta/results/",
...
extend_param_dicts(param_dicts, shared_params,
                   {
                       ...
                       #"agent": ["rnn_WTI_even_less", "rnn_WTI_less"],
