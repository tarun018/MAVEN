...
label = "_pred_prey_sf_0407_v1234_"
config = "vdn_journal_sf"
env_config = "pred_prey_tf_tasks_prey_p333p_pen_2_0"
...
shared_params = {
    "local_results_path": "/data/phoenix/tarpta/results/",
...
extend_param_dicts(param_dicts, shared_params,
                   {
                       ...
                       "variance_multiplier_pen": [0.1, 0.2],
